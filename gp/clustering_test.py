...
class SimpleTest2D(unittest.TestCase):
	...
	def test_kmeans(self):
		...
		centroids, assignments, numIts = clustering.kmeans(self.data, self.numClusters)		
		...
		if self.plotResults:
			self.plotData_kMeans(self.data, centroids, assignments, numIts)
	...
	def plotData_kMeans(self, data, centroids, assignments, numIts):
		...
		colourNames = ['blue', 'green', 'red', 'purple']
